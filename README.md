...
- [GhostLibrary](https://github.com/upchui/Jellyfin-GhostLibrary) - Hides selected media libraries from the Jellyfin home screen and library list while keeping server-side plugin and filesystem access unchanged.
