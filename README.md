...
- [jellyfin-helper](https://github.com/JellyPlugins/jellyfin-helper) - Provides a server administration dashboard with cleanup tasks, library statistics, health checks, Arr integration, backups, and user insights.
