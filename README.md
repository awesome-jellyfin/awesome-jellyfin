...
- [jellyfin-plugin-animethemes](https://github.com/EusthEnoptEron/jellyfin-plugin-animethemes) -  Fetches anime themes (OPs and EDs) from animethemes.moe. Both audio files and video files are supported.
...
- [jellyfin-plugin-meilisearch](https://github.com/arnesacnussem/jellyfin-plugin-meilisearch) - Improves search speed and results by utilize Meilisearch as search engine.
...
- [jelly-watch-wise](https://github.com/Joker-KP/jelly-watch-wise) - A Python application designed to help you manage and enforce watch time limits for users.
