...
- [SeerrFin](https://github.com/varunaditya-plus/SeerrFin) - Adds discovery tabs to the top bar for content discovery and requesting through Seerr directly in Jellyfin. Also adds Seerr search integration, Letterboxd watchlist importing, and quality recommendations (to help you choose a quality profile).
