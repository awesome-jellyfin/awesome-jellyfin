...
- [app](https://github.com/Shadfin/app/blob/main/README.md) - A web client for Jellyfin Media Server that allows self-hosting and may have incomplete features compared to the official client.
