...
- [jellyfin-plugin-collection-import](https://github.com/lostb1t/jellyfin-plugin-collection-import/blob/main/README.md) - Easily create and sort collections by importing from external sources like mdblist.
