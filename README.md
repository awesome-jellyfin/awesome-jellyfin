...
- [jellyfin-on-macos](https://github.com/Digital-Shane/jellyfin-on-macos/blob/main/README.md) - Guide for hosting Jellyfin on macOS with dynamic DNS, geo-filtering, and monitoring dashboards. 
