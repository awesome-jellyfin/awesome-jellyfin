...
- [jellyfin-plugin-listenbrainz](https://github.com/lyarenei/jellyfin-plugin-listenbrainz) - Allows you to record your music activity directly from Jellyfin server to ListenBrainz.
