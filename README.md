...
- [jellyfin-transcode-nag](https://github.com/voc0der/jellyfin-transcode-nag) - Send configurable Jellyfin nag message when people are transcoding but probably shouldn't be.
