...
- [moonbase](https://github.com/Moonfin-Client/Plugin) - Companion plugin for Moonfin which allows for a centralized configuration and syncing of the Moonfin client settings. Also adds Moonfin Web app. 
