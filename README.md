...
<!-- sort list:plugins -->
- [Jellyfin Donate Plugin](https://github.com/lyaschuchenko/jellyfin-plugin-donate) - Seamlessly integrate a smart, localized 'Donate' button directly into your Jellyfin Web UI.
