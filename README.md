...
- [Jellyfin-Image-Exporter](https://github.com/Kurotaku-sama/Jellyfin-Image-Exporter) - Exports metadata images from Jellyfin's library folder and places them into the same folder structure on the file system.
