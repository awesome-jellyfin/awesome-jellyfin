...
- [Ondine](https://github.com/luishidalgoa/ondine) - Renames episodes against a catalogue, splits files holding several episodes, reports missing ones and compresses with a size forecast.
